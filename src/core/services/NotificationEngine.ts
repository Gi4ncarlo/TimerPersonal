...
const MESSAGE_POOL: Record<NotificationType, MessageTemplate> = {
    ...
    inactivity: {
        ...
        messages: {
            low: [
                ...
                'El día avanza y tus sendas siguen en cero. ¡Todavía estás a tiempo!',
            ...
            medium: [
                ...
                'El reloj corre y tus sendas siguen en 0 hoy. ¿Qué onda?',
                'Tus competidores están registrando mientras vos... ¿descansás? 🤔',
                'El día ya arrancó y tus sendas no. ¿Cuándo empezás? 😏',
                'Tu tablero está más vacío que heladera de estudiante. Registrá algo. 🧊',
                'Mientras vos leés esto, alguien está sumando sendas. Solo digo... 👀',
                '0 actividades hoy. Eso es menos que tu sombra. Ella al menos se mueve. 🫥',
                'Otro día que empieza sin sendas. ¿Aburrido de ganar? 🥱',
            ],
            brutal: [
                'Tus libros te extrañan... y tus sendas negativos te están saludando. 📉',
                ...
                'El sofá no da sendas. Levantate y registrá algo, dale. 🛋️',
                'Tu historial de hoy es más vacío que tu excusa favorita. 💀',
                'Alerta de productividad negativa: 0 horas, 0 sendas, 100% vergüenza. 📊',
    ...
    ranking_drop: {
        ...
        messages: {
            ...
            medium: [
                ...
                '{leader} está on fire con {points} sendas. Tu turno de responder. 🔥',
            ...
            brutal: [
                ...
                '{leader} te pasó en el ranking con {points} sendas. Tu dignidad está en juego. 🪦',
                'Breaking News: {leader} te destruyó en el ranking. Tus excusas no suman sendas. 📰',
                ...
                '{leader} te dió una clase magistral de productividad con {points} sendas. Sentate y tomá apuntes. 📝',
    ...
    weekly_decline: {
        ...
        messages: {
            ...
            brutal: [
                ...
                'Caída del {percent}%. A este ritmo, la semana que viene vas a deber sendas. 💸',
    ...
    comeback: {
        ...
        messages: {
            low: [
                ...
                'Después de {days} días, acá estás de nuevo. ¡A sumar sendas!',
            ],
            medium: [
            ...
            brutal: [
                '¡El hijo pródigo regresa después de {days} días! Tus sendas están en terapia. 🏥',
    ...
    achievement: {
        ...
        messages: {
            low: [
                ...
                '¡Bien hecho! Completaste "{mission}" y ganaste {points} sendas.',
                'Objetivo alcanzado: "{mission}". ¡Seguí así!',
                '"{mission}" completada con éxito. ¡{points} sendas sumados! 🎉',
                '¡Lo lograste! "{mission}" lista. A por la siguiente.',
                'Excelente: "{mission}" terminada. {points} sendas para vos. ⭐',
                '"{mission}" ✓ — ¡Gran trabajo! Seguí sumando.',
                '¡{points} sendas ganados! Misión "{mission}" completada. 💪',
            ],
            medium: [
                '¡Boom! "{mission}" liquidada. {points} sendas a la bolsa. 💰',
                'Tachaste "{mission}" de la lista. Nada mal. 😎',
                'Una menos: "{mission}". A por la siguiente.',
                '"{mission}" completada. Tu cuenta bancaria de sendas agradece. 🏧',
                '¡Zas! "{mission}" destruida. +{points} sendas a tu nombre. 💥',
                'Misión "{mission}": eliminada. Empezás a asustar a tus rivales. 😈',
                '"{mission}" out. {points} sendas in. Así se hace. 🔄',
            ...
            brutal: [
                ...
                'Por fin hiciste "{mission}". {points} sendas para que no llores. 🍼',
                'Oh, completaste "{mission}". ¿Querés un aplauso? 👏... ahí tenés.',
                '"{mission}" terminada. Un logro tan básico merece... estos {points} sendas. 🎁',
                'Wow, hiciste "{mission}". Impresionante. Bueno, no tanto. Pero sumaste {points} sendas. 🤷',
                '"{mission}" completada. Sabemos que costó. A vos todo te cuesta. Pero lo hiciste. 😤',
                'Finalmente "{mission}" done. El bar estaba bajo, y aun así te costó. {points} sendas. 📏',
            ],
        },
    },
    ...
    personal_record: {
        ...
        messages: {
            low: [
                '¡Nuevo récord personal! {recordValue} sendas en un solo día. ¡Increíble!',
                '¡Superaste tu mejor marca! {recordValue} sendas hoy. ¡Seguí así!',
                'Día histórico: {recordValue} sendas, tu mejor día hasta ahora. 🎉',
                '¡Rompiste tu propio récord con {recordValue} sendas! Impresionante.',
                'Tu mejor día acaba de actualizarse: {recordValue} sendas. ¡Bravo!',
                '{recordValue} sendas hoy — eso es un nuevo máximo personal. 🏔️',
                '¡Nuevo pico! {recordValue} sendas hoy, superando tu marca anterior.',
                'Histórico: nunca habías tenido un día de {recordValue} sendas. ¡Wow!',
            ],
            medium: [
                '🚨 ¡NUEVO RÉCORD! {recordValue} sendas en un día. Tu versión anterior queda obsoleta. 📈',
                '¡{recordValue} sendas! Acabás de reescribir tu propia historia. El viejo récord llora. 😢',
                'Récord aplastado: {recordValue} sendas. Tu gráfico necesita zoom out. 🔭',
                '{recordValue} sendas hoy. Tu yo del pasado está shockeado. Tu yo del futuro, orgulloso. ⏳',
                '¡Boom! {recordValue} sendas = nuevo récord. Los demás deberían estar preocupados. 🎯',
                'Récord personal destrozado: {recordValue} sendas. Eso no se ve todos los días. 🌟',
                '{recordValue} sendas en un día. Si alguien te decía que podías, tenía razón. 💪',
                '¡Record day! {recordValue} sendas. Tu mejor versión acaba de llegar. 🏅',
            ],
            brutal: [
                '¡{recordValue} sendas! ¿Quién sos y qué hiciste con el vago de siempre? 🤖',
                'Récord: {recordValue} sendas. Impresionante para alguien que usualmente hace lo mínimo. 🙄',
                '{recordValue} sendas en un día. Milagro certificado. ¿Quién te amenazó? 🔫',
                '¡Nuevo récord de {recordValue} sendas! Demostraste que podías. ¿Por qué no lo hacés siempre? 🤨',
                '{recordValue} sendas. Un día productivo entre muchos mediocres. Pero hey, récord es récord. 🎪',
                'OMG {recordValue} sendas. ¿Tomaste algo? Porque normalmente no rendís así. ☕',
                'Récord de {recordValue} sendas. Esperemos que no sea un evento astronómico irrepetible. 🌌',
                '{recordValue} sendas hoy. Tu madre estaría orgullosa. Por primera vez. 💀',
            ],
        },
    },
    ...
    competitive_taunt: {
        ...
        messages: {
            low: [
                '¡Estás a solo {gap} sendas de superar a {rival}! ¡Un poco más y lo lográs!',
                '{rival} está a {gap} sendas por encima tuyo. ¡Recortá la distancia!',
                'La diferencia con {rival} es de solo {gap} sendas. ¡Podés cerrarlo hoy!',
                'Estás cerquísima de {rival}: solo {gap} sendas de diferencia. ¡Dale!',
                '{rival} está al alcance: {gap} sendas. ¡Un buen día y lo pasás!',
                'La brecha con {rival} se achica: {gap} sendas. ¡Seguí así!',
                'A {gap} sendas de {rival}. Cada actividad te acerca más. 🎯',
                '¡Casi! {gap} sendas separan entre vos y {rival}. ¡Hoy podés pasarlo!',
            ],
            medium: [
                '{rival} está a {gap} sendas. Un día productivo y le comés el puesto. ¿Aceptás el desafío? 😈',
                'Solo {gap} sendas te separan de {rival}. ¿Vas a dejar esa oportunidad pasar? 🤔',
                '{rival} duerme tranquilo a {gap} sendas de ventaja. ¿Le arruinamos el sueño? 😏',
                'A {gap} sendas de {rival}. El leaderboard se pone picante. ¿Quién da más? 🌶️',
                '{rival} no sabe que estás a {gap} sendas. Surprise attack incoming. 🥷',
                'Diferencia con {rival}: {gap} sendas. Eso se cierra en un día con ganas. ¿Tenés ganas? 💪',
                'Sprint final: {gap} sendas y superás a {rival}. ¿Hoy es el día? 🏁',
                '{rival} te lleva {gap} sendas. Nada que un buen turbo-día no pueda resolver. 🚀',
            ],
            brutal: [
                '{rival} te gana por {gap} míseros sendas. Si no lo pasás hoy, no tenés excusa. Literalmente ninguna. 💀',
                '{gap} sendas es lo que te separa de {rival}. Eso es nada. NADA. ¿Y no lo pasás? Vergonzoso. 🤡',
                '{rival} está a {gap} sendas. Si tuvieras la mitad de disciplina que tu ego, ya lo habrías pasado. 🪞',
                'A {gap} sendas de {rival}. Un café, una hora de estudio, y lo humillás. ¿O seguís siendo tibio? ☕',
                '{gap} sendas de diferencia con {rival}. Podés cerrar eso tosiendo. ¿Qué esperás, una invitación formal? 📩',
                '{rival} te lleva {gap} sendas. Pathetic. Un buen día y se acabó. ¿Pero tenés "buenos días"? 😐',
                'Solo {gap} sendas te separan de la gloria (bueno, de pasar a {rival}). Dejá de leer esta notificación y ponete a producir. 📵',
                '{rival} cree que está seguro con {gap} sendas de ventaja. Demostrále que no. O seguí sentado, como siempre. 🛋️',
            ],
        },
    },
    ...
    hourly_nudge: {
        ...
        messages: {
            low: [
                ...
                'Tu hora dorada: {peakHour}hs. Históricamente es cuando más sendas sumás. ⭐',
            ...
            medium: [
                ...
                'Son las {peakHour}hs. Normalmente ya estarías sumando sendas. ¿Hoy qué onda? 🤔',
    ...
    best_day_reminder: {
        ...
        messages: {
            low: [
                ...
                '¡Hoy es {bestDay}! Tu día favorito para sumar sendas. ¡Dale!',
